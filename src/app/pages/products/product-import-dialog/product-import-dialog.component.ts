...
import { ProductService } from 'src/app/services/products.service'; // Correct Service
...
@Component({
  ...
  styleUrls: ['./product-import-dialog.component.scss'] // Add this
})
export class ProductImportDialogComponent {
  ...
  constructor(
    ...
    private productService: ProductService, // Correct Service
  ...
  downloadTemplate(): void {
    ...
    this.productService.getImportTemplate()
      ...
      .subscribe(blob => saveAs(blob, 'Product_Import_Template.xlsx'));
  }
